This is an old version of the readme for reference. Please check out [the latest readme](README)

# Javascript SQL database for (traditional) relational tables and nested JSON data (noSQL). 
