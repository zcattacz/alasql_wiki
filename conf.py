...
copyright = u'2014-2017, Andrey Gershun (agershun@gmail.com) & Mathias Rangel Wulff (m@rawu.dk)'
author = u'Andrey Gershun & Mathias Rangel Wulff'

github_doc_root = 'https://github.com/zcattacz/alasql_wiki/master/'
...
man_pages = [
    (master_doc, 'alasql_wiki', u'AlaSQL Wiki',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'alasql_wiki', u'AlaSQL Wiki',
   author, 'alasql_wiki', 'sql in javascript.',
   'sql'),
]
...
# app setup hook
def setup(app):
    app.add_config_value('alasql_wiki_config', {
